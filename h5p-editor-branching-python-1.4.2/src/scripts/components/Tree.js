...
export default class Tree extends React.Component {
  ...
  renderNode = (branch) => {
    ...
    // When a node is moved and the previous parent is now the final node, Ensure it gets counted in end python counter
    ...
    // Add dropzones when placing, except for below the one being moved and for end pythons
