...
/*global H5PEditor*/
H5PEditor.widgets.branchingPython = H5PEditor.BranchingPython = (function () {
  /**
   * Initialize Branching Python editor.
   *
   * @class H5PEditor.BranchingPython
   * @param {Object} parent - Parent.
   * @param {Object} field - Contents.
   * @param {Object} params - Params.
   * @param {function} setValue - Callback.
   */
  function BranchingPythonEditor(parent, field, params, setValue) {
    this.parent = parent;
    // Fields of semantics
    this.field = field;
    ...
    this.title = t('branchingPythonTitle');
   ...
   * on load
   */
  BranchingPythonEditor.prototype.buildContentEditorForms = function () {
    // Render all common fields of branching python
   ...
   */
  BranchingPythonEditor.prototype.getNewContent = function (params) {
   ...
   */
  BranchingPythonEditor.prototype.validate = function () {
    let valid = true;
   ...
   */
  BranchingPythonEditor.prototype.findTranslationFields = function (chunk) {
    let fields = [];
   ...
   */
  BranchingPythonEditor.prototype.validateChunk = function (chunk) {
   ...
   */
  BranchingPythonEditor.prototype.ready = function (ready) {
    if (this.passReadies) {
   ...
   * @param {function} ready
   */
  BranchingPythonEditor.prototype.remove = function () {
    // Reset editor width
   ...
   */
  BranchingPythonEditor.prototype.handleContentChanged = function (content) {
   ...
   */
  BranchingPythonEditor.prototype.appendTo = function ($wrapper) {
    const self = this;
