H5P.BranchingPython.Scoring = (function () {
  ...
  function Scoring(params) {
    ...
    const calculateStaticMaxScore = function () {
      ...
      // Find max score by checking which ending python has the highest score
    ...
    /**
     * Get max score for the whole branching python depending on scoring options
     *
