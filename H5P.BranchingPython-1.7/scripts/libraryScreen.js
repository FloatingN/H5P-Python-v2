...
H5P.BranchingPython.LibraryScreen = (function ($) {

  /**
   * LibraryScreen
   *
   * @param  {BranchingPython} parent BranchingPython object
  ...
  function LibraryScreen(parent, courseTitle, library) {
    ...
    this.currentLibraryElement = libraryWrapper.getElementsByClassName('h5p-branching-python-content')[0];
    ...
    if (this.parent.navigating === false) {
      ...
      if (hasFeedback && this.nextLibraryId !== -1) {
        ...
        if (this.overlay === undefined) {
          ...
          this.overlay.className = 'h5p-branching-python-overlay';
        ...
        branchingQuestion.classList.add('h5p-branching-python-feedback-dialog');
  ...
  LibraryScreen.prototype.createLibraryElement = function (library, isNextLibrary) {
    ...
    libraryElement.classList.add('h5p-branching-python-content');
    ...
    this.contentOverlays[library.contentId] = new H5P.BranchingPython.LibraryScreenOverlay(this);
  ...
  */
  ...
  LibraryScreen.prototype.showNextLibrary = function (library, reverse = false) {
    ...
    if (!LibraryScreen.isBranching(library)) {
      ...
      const libraryElement = libraryWrapper.getElementsByClassName('h5p-branching-python-content')[0];
      ...
      this.currentLibraryWrapper.addEventListener('animationend', function () {
        ...
        self.currentLibraryElement = libraryWrapper.getElementsByClassName('h5p-branching-python-content')[0]; // TODO: Why no use 'libraryElement' ?
      ...
      if (parent.navigating === false) {
        ...
        if (hasFeedback && self.nextLibraryId !== -1) {
          ...
          if (self.overlay === undefined) {
            ...
            self.overlay.className = 'h5p-branching-python-overlay';
