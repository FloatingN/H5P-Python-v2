H5P.BranchingPython.GenericScreen = (function () {
  ...
  function GenericScreen(parent, screenData) {
    ...
    contentDiv.classList.add('h5p-branching-python-screen-content');
    ...
    title.className = 'h5p-branching-python-title-text';
    title.innerHTML = screenData.titleText;

    const subtitle = document.createElement('div');
    subtitle.className = 'h5p-branching-python-subtitle-text';
